...
a persistence unit "bip-earPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bip-ear/pom.xml":
...
artifacts ("bip-ear-ejb.jar" and "bip-ear-web.war") are already built. You can build
